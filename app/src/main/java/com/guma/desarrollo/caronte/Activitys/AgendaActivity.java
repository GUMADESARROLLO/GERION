...
public class AgendaActivity extends AppCompatActivity implements SearchView.OnQueryTextListener,SearchView.OnCloseListener{
    ...
    private void loadData() {
        ...
        chilRows.add(new ChildRow(R.drawable.ic_event_black_24dp,"Cliente 2"));
        parentRow = new ParentRow("MARTES",chilRows);
        parentList.add(parentRow);

        chilRows.add(new ChildRow(R.drawable.ic_event_black_24dp,"Cliente 3"));
        parentRow = new ParentRow("MIERCOLES",chilRows);
        parentList.add(parentRow);

        chilRows.add(new ChildRow(R.drawable.ic_event_black_24dp,"Cliente 4"));
        parentRow = new ParentRow("JUEVES",chilRows);
        parentList.add(parentRow);

        chilRows.add(new ChildRow(R.drawable.ic_event_black_24dp,"Cliente 5"));
